    ...
    public partial class frm_PLANCRM_S : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void save()
        {
            ...
            if (_insert == true)
            {
                ...
                Function.clsFunction.sysTrace(this.Name, Function.clsFunction.transLate(btn_insert_allow_insert.Text), txt_idplan_IK1.Text, txt_planname_50_I2.Text, SystemInformation.ComputerName.ToString(), "0", ds.GetXml(), Assembly.GetAssembly(this.GetType()).ToString().Split(',')[0]);
                saveMission();
        ...
        private bool checkInput()
        {
            ...
            if (txt_planname_50_I2.Text == "")
            {
                txt_planname_50_I2.Focus();
                dxEp_error_S.SetError(txt_planname_50_I2, Function.clsFunction.transLateText("Không được rỗng"));
                return false;
            }
            if (txt_planname_50_I2.Text == "")
            {
            ...
            if (dte_fromdate_I5.EditValue==null)
            {
            ...
            if (dte_todate_I5.EditValue == null)
            {
            ...
            if (glue_idpriority_I1.EditValue == null)
            {
                dxEp_error_S.SetError(glue_idpriority_I1, Function.clsFunction.transLateText("Không được rỗng"));
                glue_idpriority_I1.Focus();
                return false;
            }
        ...
        private void loadGridLookupCampaign()
        {
            ...
            ControlDev.FormatControls.LoadGridLookupEdit(glue_idcampaign_I1, "select idcampaign, campaign from dmcampaign", "campaign", "idcampaign", caption, fieldname, this.Name, glue_idcampaign_I1.Width);
        }
        #endregion        
