    ...
    public partial class frm_NewFormList_SH : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_sua_S_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frm.lbl_IDSubMenu_I1.Text = gv_danhmuc_C.GetRowCellValue(gv_danhmuc_C.FocusedRowHandle, Function.clsFunction.getNameControls(frm.lbl_IDSubMenu_I1.Name)).ToString();
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void btn_them_S_Click(object sender, EventArgs e)
        {
            ...
            frm.langues = langues;
            frm.statusForm = statusForm;
            frm.lbl_IDSubMenu_I1.Text = Function.clsFunction.layMa(dauma, Function.clsFunction.getNameControls(frm.lbl_IDSubMenu_I1.Name), Function.clsFunction.getNameControls(frm.Name));
            frm.ShowDialog();
            row_focus = -1;
        }
